module UpdateExp
  ...
  def update_streak_mtp(amended_ans_q)
    lesson_exp = StudentLessonExp.find_by(lesson_id: amended_ans_q.lesson_id,
                                          user_id: amended_ans_q.user_id)
