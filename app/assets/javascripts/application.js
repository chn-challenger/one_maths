...
function showSolutions() {
  $(document).ready(function() {
    ...
    var submitAnswerSolution = function(event){
      ...
      $(this).hide();
      $(this).siblings('.answer-next-question').show();
    ...
    $('.answer-next-question').on('click', function(event){
      event.preventDefault();
        var nextQuestionLink = $(this);
        var nextQuestionDiv = $(this).parent().parent();
        var nextQuestionForm = $(this).parent();
      ...
      $.get(this.href, function(response){
        if (response.question == "") {
          ...
          nextQuestionLink.hide();
          nextQuestionForm.children('.answer-solution-link').show();
          MathJax.Hub.Typeset();
        };
      });
    });
